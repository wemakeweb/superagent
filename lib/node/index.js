...
/**
 * Set the key and cert option for https request.
 *
 ...
 * @api public
 */
Request.prototype.tls = function(cert, key){
  this._cert = cert;
  this._key = key;
...
/**
 * Set disbales the server indentity check.
 *
 * @return {Request} for chaining
 * @api public
 */

Request.prototype.disableIdentityCheck = function(){
  this.options.disableIdentityCheck = true;
...
Request.prototype.request = function(){
  ...
  if(options.disableIdentityCheck){
